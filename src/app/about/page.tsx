      ...
      <main className="flex-1">
        <section className="max-w-3xl mx-auto px-6 py-20">
          ...
          <div className="glass-dark rounded-3xl p-8 mb-6">
            <h2 className="text-xl font-bold text-white mb-4">Почему этот проект появился</h2>
            <div className="space-y-4 text-white/50 leading-relaxed">
              <p>
                Когда ChatGPT стал доступен широкой аудитории, все вокруг говорили об AI. Но большинство контента было либо слишком техническим, либо слишком поверхностным.
              </p>
              <p>
                Предприниматели задавали простые вопросы: <span className="text-white/70">«Как мне это использовать прямо сейчас? Что конкретно написать? Как сэкономить время на задачах которые отнимают часы?»</span>
              </p>
              <p>
                Этот проект — ответ на эти вопросы. Только практика. Только конкретные сценарии. Только то что работает в реальном бизнесе.
              </p>
            </div>
          </div>
